    ...
    <nav class="navbar navbar-toggleable-md fixed-top navbar-transparent" color-on-scroll="500">
        <div class="container">
            <div class="navbar-translate">
                ...
                <a class="navbar-brand" onclick="window.location.reload()">MAX MUSIC</a>
            </div>
            <div class="collapse navbar-collapse" id="navbarToggler">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
						<a href="/registration" target="_blank" class="btn btn-danger btn-round">Telecharge Notre APP</a>
					</li>
                </ul>
            </div>
        </div>
    			...
    			<div class="container">
    				<div class="title-brand">
                        ...
                        <br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
                                                    <iframe class="ytp" src="https://www.youtube.com/embed/LG2xNLvAwIU?vq=hd1080&autoplay=1&loop=1&fs=0&autohide=0&controls=0" width="800" height="460" frameborder="0"></iframe>
                                                    <br><br><br><br>
    					<div class="fog-low right">
    					</div>
    				</div>
                    <br><br><br>
    				<h2 class="presentation-subtitle text-center">Découvre l'app electron qui te permet d'afficher ta musique favorite</h2>
